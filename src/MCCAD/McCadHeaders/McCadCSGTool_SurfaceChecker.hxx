...
public:
Standard_EXPORT    bool readFile(TCollection_AsciiString inName, TCollection_AsciiString logFileName="surfaceCheck.log");
Standard_EXPORT    void readDirectory(TCollection_AsciiString astring, TCollection_AsciiString logFileName="surfaceCheck.log");
