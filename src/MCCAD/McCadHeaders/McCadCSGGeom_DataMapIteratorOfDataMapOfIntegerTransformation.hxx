...
class McCadCSGGeom_DataMapIteratorOfDataMapOfIntegerTransformation  : public TCollection_BasicMapIterator {
...
Standard_EXPORT McCadCSGGeom_DataMapIteratorOfDataMapOfIntegerTransformation(const McCadCSGGeom_DataMapOfIntegerTransformation& aMap);


Standard_EXPORT   void Initialize(const McCadCSGGeom_DataMapOfIntegerTransformation& aMap) ;


Standard_EXPORT  const Standard_Integer& Key() const;


Standard_EXPORT  const Handle_McCadCSGGeom_Transformation& Value() const;
