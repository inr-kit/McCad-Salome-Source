...
#ifndef _McCadViewTool_RedisplaySelected_HeaderFile
#define _McCadViewTool_RedisplaySelected_HeaderFile

#ifndef _Standard_HeaderFile
#include <Standard.hxx>
#endif
#ifndef _Handle_McCadViewTool_RedisplaySelected_HeaderFile
#include <Handle_McCadViewTool_RedisplaySelected.hxx>
#endif
...
//! RedisplaySelected Task class <br>
class McCadViewTool_RedisplaySelected : public McCadTool_Task {
...
Standard_EXPORT McCadViewTool_RedisplaySelected(const Handle(McCadCom_CasDocument)& theDoc = NULL,const Handle(McCadCom_CasView)& theView = NULL,const McCadTool_State theState = McCadTool_Start,const Standard_Boolean theUndoState = Standard_False,const Standard_Boolean theRedoState = Standard_False);

//! Deletes t<me>. <br>
Standard_EXPORT virtual  void Destroy() ;
~McCadViewTool_RedisplaySelected()
{
  Destroy();
}
