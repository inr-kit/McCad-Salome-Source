...
#ifndef _McCadViewTool_Default_HeaderFile
#define _McCadViewTool_Default_HeaderFile

#ifndef _Standard_HeaderFile
#include <Standard.hxx>
#endif
#ifndef _Handle_McCadViewTool_Default_HeaderFile
#include <Handle_McCadViewTool_Default.hxx>
#endif
...
class McCadViewTool_Default : public McCadTool_Task {
...
Standard_EXPORT McCadViewTool_Default(const Handle(McCadCom_CasDocument)& theDoc = NULL,const Handle(McCadCom_CasView)& theView = NULL,const McCadTool_State theState = 
McCadTool_Start,const Standard_Boolean theUndoState = Standard_False,const Standard_Boolean theRedoState = Standard_False);

//! Deletes t<me>. <br>
Standard_EXPORT virtual  void Destroy() ;
~McCadViewTool_Default()
{
  Destroy();
}
