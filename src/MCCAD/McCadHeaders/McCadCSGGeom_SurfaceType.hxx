...
//!  This package contains the definition of the geometric objects <br>
enum McCadCSGGeom_SurfaceType {
 McCadCSGGeom_Planar,
McCadCSGGeom_Conical,
McCadCSGGeom_Cylindrical,
McCadCSGGeom_Spherical,
McCadCSGGeom_Toroidal,
McCadCSGGeom_Quadric,
McCadCSGGeom_SurfOfRev,
McCadCSGGeom_OtherSurface
};
