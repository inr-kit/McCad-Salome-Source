...
#ifndef _McCadViewTool_SetVisuMaterial_HeaderFile
#define _McCadViewTool_SetVisuMaterial_HeaderFile

#ifndef _Standard_HeaderFile
#include <Standard.hxx>
#endif
#ifndef _Handle_McCadViewTool_SetVisuMaterial_HeaderFile
#include <Handle_McCadViewTool_SetVisuMaterial.hxx>
#endif
...
//! Set/Unset SetVisuMaterial Task class <br>
class McCadViewTool_SetVisuMaterial : public McCadTool_Task {
...
Standard_EXPORT McCadViewTool_SetVisuMaterial(const Handle(McCadCom_CasDocument)& theDoc = NULL,const Handle(McCadCom_CasView)& theView = NULL,const McCadTool_State theState = McCadTool_Start,const Standard_Boolean theUndoState = Standard_False,const Standard_Boolean theRedoState = Standard_False);

//! Deletes t<me>. <br>
Standard_EXPORT virtual  void Destroy() ;
~McCadViewTool_SetVisuMaterial()
{
  Destroy();
}
...
Standard_EXPORT void SetMaterialName(Graphic3d_NameOfMaterial theNOM);
...
private:
 ...
 // Methods PRIVATE
 //
Graphic3d_NameOfMaterial myNOM;
