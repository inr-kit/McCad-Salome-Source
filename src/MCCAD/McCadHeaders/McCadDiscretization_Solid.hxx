...
#ifndef _McCadDiscretization_Solid_HeaderFile
#define _McCadDiscretization_Solid_HeaderFile
...
//! \brief Algorithm to discretize a TopoDS_Solid


class McCadDiscretization_Solid  {
...
//!  method implementation the same as in the face class <br>
Standard_EXPORT McCadDiscretization_Solid();


Standard_EXPORT McCadDiscretization_Solid(McCadDiscDs_DiscSolid& theDsSolid);


Standard_EXPORT   void Init() ;


Standard_EXPORT   void SetSolid(McCadDiscDs_DiscSolid& theDsSolid) ;


Standard_EXPORT   McCadDiscDs_DiscSolid GetSolid() const;
