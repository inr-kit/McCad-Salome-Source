...
#ifndef _McCadCSGGeom_Cone_HeaderFile
#define _McCadCSGGeom_Cone_HeaderFile

#ifndef _Standard_HeaderFile
#include <Standard.hxx>
#endif
#ifndef _Handle_McCadCSGGeom_Cone_HeaderFile
#include <Handle_McCadCSGGeom_Cone.hxx>
#endif
...
//! \brief Conical surface class

class McCadCSGGeom_Cone : public McCadCSGGeom_Surface {
...
//! <br>
Standard_EXPORT McCadCSGGeom_Cone();

//! set axes as KX,KY,KZ <br>
Standard_EXPORT McCadCSGGeom_Cone(const gp_Ax3& A3,const Standard_Real Ang,const Standard_Real theRadius);

//! set axes as KX,KY,KZ - take into account that single sheets can be selected <br>
Standard_EXPORT McCadCSGGeom_Cone(const gp_Ax3& A3,const Standard_Real Ang,const Standard_Real theRadius, const int sheet);
...
Standard_EXPORT   Standard_Real GetSemiAngle() const;
...
//! return the sheet value (+/-1, 0), if 0 both sheets are equally valid
Standard_EXPORT int Sheet();
