...
#ifndef _McCadCom_SequenceNodeOfSequenceOfCasView_HeaderFile
#define _McCadCom_SequenceNodeOfSequenceOfCasView_HeaderFile
...
class McCadCom_SequenceOfCasView;



class McCadCom_SequenceNodeOfSequenceOfCasView : public TCollection_SeqNode {

public:
 // Methods PUBLIC
 // 

McCadCom_SequenceNodeOfSequenceOfCasView(const Handle(McCadCom_CasView)& I,const TCollection_SeqNodePtr& n,const TCollection_SeqNodePtr& p);

  Handle_McCadCom_CasView& Value() const;
//Standard_EXPORT ~McCadCom_SequenceNodeOfSequenceOfCasView();
