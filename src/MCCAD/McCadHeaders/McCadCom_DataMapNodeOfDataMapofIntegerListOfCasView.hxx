...
#ifndef _McCadCom_DataMapNodeOfDataMapofIntegerListOfCasView_HeaderFile
#define _McCadCom_DataMapNodeOfDataMapofIntegerListOfCasView_HeaderFile
...
class McCadCom_DataMapofIntegerListOfCasView;
class McCadCom_DataMapIteratorOfDataMapofIntegerListOfCasView;



class McCadCom_DataMapNodeOfDataMapofIntegerListOfCasView : public TCollection_MapNode {

public:
 // Methods PUBLIC
 // 

McCadCom_DataMapNodeOfDataMapofIntegerListOfCasView(const Standard_Integer& K,const McCadCom_ListOfCasView& I,const TCollection_MapNodePtr& n);

  Standard_Integer& Key() const;

  McCadCom_ListOfCasView& Value() const;
//Standard_EXPORT ~McCadCom_DataMapNodeOfDataMapofIntegerListOfCasView();
...
McCadCom_ListOfCasView myValue;
