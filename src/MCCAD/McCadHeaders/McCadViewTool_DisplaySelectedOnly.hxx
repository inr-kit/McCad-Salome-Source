...
#ifndef _McCadViewTool_DisplaySelectedOnly_HeaderFile
#define _McCadViewTool_DisplaySelectedOnly_HeaderFile

#ifndef _Standard_HeaderFile
#include <Standard.hxx>
#endif
#ifndef _Handle_McCadViewTool_DisplaySelectedOnly_HeaderFile
#include <Handle_McCadViewTool_DisplaySelectedOnly.hxx>
#endif
...
//! DisplaySelectedOnly Task class <br>
class McCadViewTool_DisplaySelectedOnly : public McCadTool_Task {
...
Standard_EXPORT McCadViewTool_DisplaySelectedOnly(const Handle(McCadCom_CasDocument)& theDoc = NULL,const Handle(McCadCom_CasView)& theView = NULL,const McCadTool_State theState = McCadTool_Start,const Standard_Boolean theUndoState = Standard_False,const Standard_Boolean theRedoState = Standard_False);
