...
#define _McCadAEV_ListIteratorOfListOfViewerPtr_HeaderFile
...
Standard_EXPORT McCadAEV_ListIteratorOfListOfViewerPtr();


Standard_EXPORT McCadAEV_ListIteratorOfListOfViewerPtr(const McCadAEV_ListOfViewerPtr& L);


Standard_EXPORT   void Initialize(const McCadAEV_ListOfViewerPtr& L) ;
...
Standard_EXPORT   McCadAEV_ViewerPtr& Value() const;


friend class McCadAEV_ListOfViewerPtr;
