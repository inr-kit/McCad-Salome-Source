...
#ifndef _McCadViewTool_BackProject_HeaderFile
#define _McCadViewTool_BackProject_HeaderFile

#ifndef _Standard_HeaderFile
#include <Standard.hxx>
#endif
#ifndef _Handle_McCadViewTool_BackProject_HeaderFile
#include <Handle_McCadViewTool_BackProject.hxx>
#endif
...
//! BackProject Task class <br>
class McCadViewTool_BackProject : public McCadTool_Task {
...
Standard_EXPORT McCadViewTool_BackProject(const Handle(McCadCom_CasDocument)& theDoc = NULL,const Handle(McCadCom_CasView)& theView = NULL,const McCadTool_State theState = McCadTool_Start,const Standard_Boolean theUndoState = Standard_False,const Standard_Boolean theRedoState = Standard_False);

//! Deletes t<me>. <br>
Standard_EXPORT virtual  void Destroy() ;
~McCadViewTool_BackProject()
{
  Destroy();
}
