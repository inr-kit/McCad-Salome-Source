...
#define _McCadTDS_SequenceNodeOfSequenceOfExtSolid_HeaderFile
...
class McCadTDS_SequenceNodeOfSequenceOfExtSolid : public TCollection_SeqNode {

public:
 // Methods PUBLIC
 // 

McCadTDS_SequenceNodeOfSequenceOfExtSolid(const Handle(McCadTDS_ExtSolid)& I,const TCollection_SeqNodePtr& n,const TCollection_SeqNodePtr& p);

  Handle_McCadTDS_ExtSolid& Value() const;
//Standard_EXPORT ~McCadTDS_SequenceNodeOfSequenceOfExtSolid();
