...
#ifndef _McCadViewTool_Axo_HeaderFile
...
#include <Handle_McCadViewTool_Axo.hxx>
#endif
...
//! Axo Task class <br>
class McCadViewTool_Axo : public McCadTool_Task {
...
Standard_EXPORT McCadViewTool_Axo(const Handle(McCadCom_CasDocument)& theDoc = NULL,const Handle(McCadCom_CasView)& theView = NULL,const McCadTool_State theState = McCadTool_Start,const Standard_Boolean theUndoState = Standard_False,const Standard_Boolean theRedoState = Standard_False);
