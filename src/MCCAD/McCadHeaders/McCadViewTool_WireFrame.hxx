...
#ifndef _McCadViewTool_WireFrame_HeaderFile
...
#include <Handle_McCadViewTool_WireFrame.hxx>
#endif
...
//! WireFrame Task class <br>
class McCadViewTool_WireFrame : public McCadTool_Task {
...
Standard_EXPORT McCadViewTool_WireFrame(const Handle(McCadCom_CasDocument)& theDoc = NULL,const Handle(McCadCom_CasView)& theView = NULL,const McCadTool_State theState = McCadTool_Start,const Standard_Boolean theUndoState = Standard_False,const Standard_Boolean theRedoState = Standard_False);
