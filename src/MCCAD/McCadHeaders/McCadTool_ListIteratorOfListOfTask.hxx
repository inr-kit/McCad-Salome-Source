...
#define _McCadTool_ListIteratorOfListOfTask_HeaderFile
...
Standard_EXPORT McCadTool_ListIteratorOfListOfTask();


Standard_EXPORT McCadTool_ListIteratorOfListOfTask(const McCadTool_ListOfTask& L);


Standard_EXPORT   void Initialize(const McCadTool_ListOfTask& L) ;
...
Standard_EXPORT   Handle_McCadTool_Task& Value() const;


friend class McCadTool_ListOfTask;
