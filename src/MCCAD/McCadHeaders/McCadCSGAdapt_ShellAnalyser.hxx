...
#ifndef _McCadCSGAdapt_ShellAnalyser_HeaderFile
#define _McCadCSGAdapt_ShellAnalyser_HeaderFile
...
class McCadCSGAdapt_ShellAnalyser  {
...
Standard_EXPORT McCadCSGAdapt_ShellAnalyser(const TopoDS_Shell& theShell);


Standard_EXPORT   void Init(const TopoDS_Shell& theShell) ;


Standard_EXPORT   Standard_Boolean CheckShell() const;
