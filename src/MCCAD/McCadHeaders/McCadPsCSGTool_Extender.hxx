...
#ifndef _McCadPsCSGTool_Extender_HeaderFile
#define _McCadPsCSGTool_Extender_HeaderFile
...
Standard_EXPORT McCadPsCSGTool_Extender();


Standard_EXPORT McCadPsCSGTool_Extender(const Handle(McCadTDS_PsSolid)& thePsSolid);
