...
#ifndef _McCadAEV_ListNodeOfListOfEditorPtr_HeaderFile
#define _McCadAEV_ListNodeOfListOfEditorPtr_HeaderFile
...
class McCadAEV_ListNodeOfListOfEditorPtr : public TCollection_MapNode {

public:
 // Methods PUBLIC
 // 

McCadAEV_ListNodeOfListOfEditorPtr(const McCadAEV_EditorPtr& I,const TCollection_MapNodePtr& n);

  McCadAEV_EditorPtr& Value() const;
//Standard_EXPORT ~McCadAEV_ListNodeOfListOfEditorPtr();
