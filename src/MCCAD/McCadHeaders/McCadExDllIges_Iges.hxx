...
#ifndef _McCadExDllIges_Iges_HeaderFile
#define _McCadExDllIges_Iges_HeaderFile
...
//! \brief Import-Export-Class for IGES files

//! IGES is a little bit outdated but still supported. Use STEP instead.

class McCadExDllIges_Iges  : public McCadEXPlug_ExchangePlugin {
...
Standard_EXPORT McCadExDllIges_Iges();

Standard_EXPORT virtual ~McCadExDllIges_Iges(){}
